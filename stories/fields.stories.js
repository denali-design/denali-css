...
export const IconAtFrontAndBack = () => {
  return (
    `<div class="input has-icon-front has-icon-back">
      <span class="d-icon d-filter-horizontal is-brand-300"></span><input type="text" placeholder="Icon back" /><a class="d-icon d-close-circle-solid is-secondary is-sub"></a>
    </div>`
  );
};
